...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//ВКМ_НачалоДоработки_СмирноваСветлана_17.04.2024_Диплом
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОбслуживаниеКлиентовРедактирование");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_МассовоеСозданиеАктов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_АнализВыставленныхАктовИспользованиеПросмотр");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ВыработкаСпециалистовИспользованиеПросмотр");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОбслуживаниеКлиентовРедактирование");
	ОписаниеПрофиля.Роли.Добавить("СохранениеДанныхПользователя");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РасходЗапланированныхОтпусковИспользованиеПросмотр");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РасчётыССотрудникамиИспользованиеПросмотр");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
